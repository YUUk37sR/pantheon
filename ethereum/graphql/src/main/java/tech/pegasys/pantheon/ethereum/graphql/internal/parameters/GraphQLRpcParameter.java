 ...
 */
package tech.pegasys.pantheon.ethereum.graphql.internal.parameters;
...
public class GraphQLRpcParameter {
  ...
  public <T> Optional<T> optional(
    ...
    if (paramClass.isAssignableFrom(rawParam.getClass())) {
      ...
      try {
        ...
        throw new InvalidGraphQLRpcParameters("Invalid json rpc parameter at index " + index, e);
