...
public class Scalars {
  ...
  public static GraphQLScalarType AddressScalar = new GraphQLScalarType("Address",
	        "An Address Scalar",
  ...
  public static GraphQLScalarType BytesScalar = new GraphQLScalarType("Bytes",
	        "A Bytes Scalar",
  ...
  public static GraphQLScalarType Bytes32Scalar = new GraphQLScalarType("Bytes32",
	        "A Bytes32 Scalar",
  ...
  public static GraphQLScalarType BigIntScalar = new GraphQLScalarType( "BigInt",
	        "A BigInteger Scalar",
  ...
  public static GraphQLScalarType LongScalar = new GraphQLScalarType("Long",
	        "A Long Scalar",
